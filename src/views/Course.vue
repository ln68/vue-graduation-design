<template>
  <div class="ke">
    ...
    <div class="k">
      ...
      <li><router-link to="/Direction" class="x">修改方向</router-link></li>
    </div>
  </div>
</template>
...
export default {
  data: () => ({
    homeworks: [
      ...
      { id: 2, name: "Java封装", weight: 2.5, deadline: "2019-05-10T12:00" },
      { id: 3, name: "Java泛型", weight: 2.5, deadline: "2019-06-10T21:30" }
    ]
  }),
  computed: {
    formatDate() {
